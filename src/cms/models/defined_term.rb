...
module Cms
  module Models
    module DefinedTerm
      ...
      COLLECTION_FILE = "defined-terms.json"
      ...
      REQUIRED_FIELDS = ["name", "termCode", "inDefinedTermSet"].freeze
      SEARCHABLE_FIELDS = ["name", "description", "termCode"].freeze
      SORTABLE_FIELDS = ["dateCreated", "dateModified", "name", "description", "termCode", "url"].freeze

      # Properties whose combined value must be unique across the collection. Empty
      # when the entity allows duplicates.
      UNIQUE_KEY = ["termCode", "inDefinedTermSet"].freeze

      SYSTEM_FIELDS = ["id", "dateCreated", "dateModified", "@context", "@type"].freeze

      REF_COLLECTIONS = { "DefinedTermSet" => "defined-term-sets.json" }.freeze

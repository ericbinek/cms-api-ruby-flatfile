...
module Cms
  module Models
    module Organization
      ...
      SEARCHABLE_FIELDS = ["name", "legalName", "description", "email", "telephone"].freeze
      SORTABLE_FIELDS = ["dateCreated", "dateModified", "name", "legalName", "description", "url", "email", "telephone", "foundingDate"].freeze

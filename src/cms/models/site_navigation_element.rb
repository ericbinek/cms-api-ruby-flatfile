...
module Cms
  module Models
    module SiteNavigationElement
      ...
      SORTABLE_FIELDS = ["dateCreated", "dateModified", "name", "url", "description", "position"].freeze
      ...
      REF_COLLECTIONS = { "SiteNavigationElement" => "site-navigation-elements.json" }.freeze

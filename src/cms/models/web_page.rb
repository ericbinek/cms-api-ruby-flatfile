...
module Cms
  module Models
    module WebPage
      TYPE_NAME = "WebPage"
      COLLECTION_FILE = "web-pages.json"
      ...
      REQUIRED_FIELDS = ["headline"].freeze
      SEARCHABLE_FIELDS = ["headline", "description", "text"].freeze
      SORTABLE_FIELDS = ["dateCreated", "dateModified", "headline", "description", "text", "datePublished", "url", "creativeWorkStatus"].freeze
      ...
      REF_COLLECTIONS = { "Person" => "persons.json", "Organization" => "organizations.json", "ImageObject" => "image-objects.json", "WebSite" => "web-sites.json" }.freeze

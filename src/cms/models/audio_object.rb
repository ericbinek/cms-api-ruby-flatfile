...
module Cms
  module Models
    module AudioObject
      ...
      COLLECTION_FILE = "audio-objects.json"
      ...
      SEARCHABLE_FIELDS = ["name", "description", "encodingFormat", "transcript"].freeze
      SORTABLE_FIELDS = ["dateCreated", "dateModified", "name", "description", "contentUrl", "encodingFormat", "duration", "transcript", "uploadDate"].freeze

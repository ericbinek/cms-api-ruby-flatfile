...
module Cms
  module Models
    module Person
      ...
      SEARCHABLE_FIELDS = ["name", "givenName", "familyName", "alternateName", "email", "description", "jobTitle"].freeze
      SORTABLE_FIELDS = ["dateCreated", "dateModified", "name", "givenName", "familyName", "alternateName", "email", "url", "description", "jobTitle"].freeze
      ...
      REF_COLLECTIONS = { "ImageObject" => "image-objects.json", "Organization" => "organizations.json" }.freeze

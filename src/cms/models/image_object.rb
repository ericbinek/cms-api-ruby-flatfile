...
module Cms
  module Models
    module ImageObject
      ...
      COLLECTION_FILE = "image-objects.json"
      ...
      SEARCHABLE_FIELDS = ["name", "caption", "description", "encodingFormat"].freeze
      SORTABLE_FIELDS = ["dateCreated", "dateModified", "name", "caption", "description", "contentUrl", "encodingFormat", "uploadDate", "license"].freeze
      ...
      REF_COLLECTIONS = { "Person" => "persons.json" }.freeze

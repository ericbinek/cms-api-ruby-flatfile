...
module Cms
  module Models
    module Comment
      ...
      REQUIRED_FIELDS = ["text", "author", "about"].freeze
      SEARCHABLE_FIELDS = ["text"].freeze
      SORTABLE_FIELDS = ["dateCreated", "dateModified", "text", "upvoteCount", "downvoteCount", "creativeWorkStatus"].freeze
      ...
      REF_COLLECTIONS = { "Person" => "persons.json", "BlogPosting" => "blog-postings.json", "Comment" => "comments.json" }.freeze
